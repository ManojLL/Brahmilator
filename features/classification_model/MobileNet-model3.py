...
train_batches = ImageDataGenerator(
    ...
    directory=train_path3, target_size=(224, 224), batch_size=10, shuffle=True)
...
output = Dense(units=54, activation='softmax')(x)
...
model_save_path = "./saved-models/saved-models-mobilenet3"
